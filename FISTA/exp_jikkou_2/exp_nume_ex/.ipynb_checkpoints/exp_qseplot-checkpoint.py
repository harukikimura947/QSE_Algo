...
def rel_plot(R_plot_list, W_plot_list, pi_plot_list, v_plot_list, Z_plot_list, 
    ...
    #フォルダの作成
    folder_path_rel = fr'C:/Users/kimura/OneDrive - 国立大学法人東北大学/numerical/short_dual/exp/graph/' \
    fr'short/long_{long}/{method}/err_short={err_short}/{dic}/RW_proj={prm.RW_proj}/alter_T_num={prm.alter_T_num}/L={algprm.L}/p_proj={algprm.p_proj}/E={prm.E}/' \
    fr'K={Col_list[0]}^2,{Col_list[1]}^2,{Col_list[2]}^2/rel_err'
    
    folder_path_val = fr'C:/Users/kimura/OneDrive - 国立大学法人東北大学/numerical/short_dual/exp/graph/' \
    fr'short/long_{long}/{method}/err_short={err_short}/{dic}/RW_proj={prm.RW_proj}/alter_T_num={prm.alter_T_num}/L={algprm.L}/p_proj={algprm.p_proj}/E={prm.E}/' \
    fr'K={Col_list[0]}^2,{Col_list[1]}^2,{Col_list[2]}^2/val'
    
    create_folder(folder_path_rel)
    create_folder(folder_path_val)
    ...
    fr'short/long_{long}/{method}/err_short={err_short}/{dic}/RW_proj={prm.RW_proj}/alter_T_num={prm.alter_T_num}/L={algprm.L}/p_proj={algprm.p_proj}/E={prm.E}/' \
    fr'K={Col_list[0]}^2,{Col_list[1]}^2,{Col_list[2]}^2/rel_err/R.jpg', format='jpg')
    ...
    plt.savefig(fr'C:/Users/kimura/OneDrive - 国立大学法人東北大学/numerical/short_dual/exp/graph/' \
    fr'short/long_{long}/{method}/err_short={err_short}/{dic}/RW_proj={prm.RW_proj}/alter_T_num={prm.alter_T_num}/L={algprm.L}/p_proj={algprm.p_proj}/E={prm.E}/' \
    fr'K={Col_list[0]}^2,{Col_list[1]}^2,{Col_list[2]}^2/rel_err/W.jpg', format='jpg')
    ...
    plt.savefig(fr'C:/Users/kimura/OneDrive - 国立大学法人東北大学/numerical/short_dual/exp/graph/' \
    fr'short/long_{long}/{method}/err_short={err_short}/{dic}/RW_proj={prm.RW_proj}/alter_T_num={prm.alter_T_num}/L={algprm.L}/p_proj={algprm.p_proj}/E={prm.E}/' \
    fr'K={Col_list[0]}^2,{Col_list[1]}^2,{Col_list[2]}^2/val/W.jpg', format='jpg')
    ...
    plt.savefig(fr'C:/Users/kimura/OneDrive - 国立大学法人東北大学/numerical/short_dual/exp/graph/' \
    fr'short/long_{long}/{method}/err_short={err_short}/{dic}/RW_proj={prm.RW_proj}/alter_T_num={prm.alter_T_num}/L={algprm.L}/p_proj={algprm.p_proj}/E={prm.E}/' \
    fr'K={Col_list[0]}^2,{Col_list[1]}^2,{Col_list[2]}^2/rel_err/pi.jpg', format='jpg')
    ...
    plt.savefig(fr'C:/Users/kimura/OneDrive - 国立大学法人東北大学/numerical/short_dual/exp/graph/' \
    fr'short/long_{long}/{method}/err_short={err_short}/{dic}/RW_proj={prm.RW_proj}/alter_T_num={prm.alter_T_num}/L={algprm.L}/p_proj={algprm.p_proj}/E={prm.E}/' \
    fr'K={Col_list[0]}^2,{Col_list[1]}^2,{Col_list[2]}^2/val/pi.jpg', format='jpg')
    ...
    plt.savefig(fr'C:/Users/kimura/OneDrive - 国立大学法人東北大学/numerical/short_dual/exp/graph/' \
    fr'short/long_{long}/{method}/err_short={err_short}/{dic}/RW_proj={prm.RW_proj}/alter_T_num={prm.alter_T_num}/L={algprm.L}/p_proj={algprm.p_proj}/E={prm.E}/' \
    fr'K={Col_list[0]}^2,{Col_list[1]}^2,{Col_list[2]}^2/rel_err/v.jpg', format='jpg')
    ...
    plt.savefig(fr'C:/Users/kimura/OneDrive - 国立大学法人東北大学/numerical/short_dual/exp/graph/' \
    fr'short/long_{long}/{method}/err_short={err_short}/{dic}/RW_proj={prm.RW_proj}/alter_T_num={prm.alter_T_num}/L={algprm.L}/p_proj={algprm.p_proj}/E={prm.E}/' \
    fr'K={Col_list[0]}^2,{Col_list[1]}^2,{Col_list[2]}^2/val/v.jpg', format='jpg')
    ...
    plt.savefig(fr'C:/Users/kimura/OneDrive - 国立大学法人東北大学/numerical/short_dual/exp/graph/' \
    fr'short/long_{long}/{method}/err_short={err_short}/{dic}/RW_proj={prm.RW_proj}/alter_T_num={prm.alter_T_num}/L={algprm.L}/p_proj={algprm.p_proj}/E={prm.E}/' \
    fr'K={Col_list[0]}^2,{Col_list[1]}^2,{Col_list[2]}^2/rel_err/Z.jpg', format='jpg')
    ...
    plt.savefig(fr'C:/Users/kimura/OneDrive - 国立大学法人東北大学/numerical/short_dual/exp/graph/' \
    fr'short/long_{long}/{method}/err_short={err_short}/{dic}/RW_proj={prm.RW_proj}/alter_T_num={prm.alter_T_num}/L={algprm.L}/p_proj={algprm.p_proj}/E={prm.E}/' \
    fr'K={Col_list[0]}^2,{Col_list[1]}^2,{Col_list[2]}^2/val/Z.jpg', format='jpg')
    ...
    plt.savefig(fr'C:/Users/kimura/OneDrive - 国立大学法人東北大学/numerical/short_dual/exp/graph/' \
    fr'short/long_{long}/{method}/err_short={err_short}/{dic}/RW_proj={prm.RW_proj}/alter_T_num={prm.alter_T_num}/L={algprm.L}/p_proj={algprm.p_proj}/E={prm.E}/' \
    fr'K={Col_list[0]}^2,{Col_list[1]}^2,{Col_list[2]}^2/val/grad.jpg', format='jpg')
