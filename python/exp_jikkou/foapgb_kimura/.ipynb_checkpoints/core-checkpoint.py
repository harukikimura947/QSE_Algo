...
class Master:
    ...
    def solve(self, m0=None, err_mas=10**(-4), max_itr=100, Lip=10):
        ...
        for k in range(1, max_itr):
            ...
            dFm_md_hist[k], W, R, n = self.dFm(m_md_hist[k])
            ...
            # if np.max(abs(m_ag_hist[k] - m_ag_hist[k-1]) / m_ag_hist[k-1]) < err_mas:
            #     break
        
        print("iteration:", max_value)
        
        return m_ag_hist, F_hist, W, R, n, max_value
